...
<div class="container-fluid">
  ...
  <div id="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="viewdressing.php">View Dressing</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" id="order">Order Dressing</a>
    </li>
    <li class="nav-item">
    ...
    <div class="col-sm-12 col-md-6 col-lg-7 mycontent">
<div class="body">
